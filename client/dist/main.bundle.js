...
var ShowComponent = (function () {
    ...
    ShowComponent.prototype.ngOnInit = function () {
        ...
        this._route.paramMap.subscribe(function (params) {
            _this._service.retrieveComment(params.get("id"), function (res) {
